...
import { BrainCogIcon, BrainIcon, GlobeIcon, icons, MonitorSmartphoneIcon, ServerCogIcon, ZapIcon } from "lucide-react";
...
const features = [
  ...
  },
  {
    ...
    description: "Engage with your PDFs like never before using our intuitivie and interactive viewer.",
    icon: BrainCogIcon
  },
  {
    name: "Cloud Backup",
...
export default function Home() {
  return (
    <main className="flex-1 bg-linear-to-bl from-white to-indigo-600 overflow-scroll p-2 lg:p-5">
        ...
        <div className="flex flex-col justify-center items-center mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              ...
              <br />
              <br />
              Upload your document, and or chatbot will answer questions, summarise content, and answer all your Qs. Ideal for everyone, {" "}
              <span className="text-indigo-600">Chat with PDF</span>{" "} turn static documents into {" "}
