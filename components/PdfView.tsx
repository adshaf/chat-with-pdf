...
// gsutil cors set cors.json gs://chat-with-pdf-3ce9d.appspot.com
// go here >>> https://console.cloud.google.com/
// create new file in editor calls cors.json
// run >>> // gsutil cors set cors.json gs://chat-with-pdf-3ce9d.appspot.com
// https://firebase.google.com/docs/storage/web/storage/web/download-files#cors_configuration
